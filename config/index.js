export const config = {
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "56cb063f03661de646f40b472b61bcda",
  ...
  USERS: [
    {
      ...
      id: "oud3H5nNSiXzBPr3E1-OL--Y-HX8",
      // 你想对他发送的模板消息的模板ID
    ...
    },
    {
      ...
      name: "ZYY",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oud3H5vlOyZ8hV8QVNk5WkIhqQmA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "bAJxg_ufnTbCdaQRHkYvSQpHPjBqbYMd09tPmwh2axg",
      // 所在省份
      province: "江苏",
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "姐妹", "year": "2002", "date": "12-19"},
        {"type": "节日", "name": "纪念日", "year": "2021", "date": "07-16"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "姐妹", "year": "2003", "date": "01-21"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
